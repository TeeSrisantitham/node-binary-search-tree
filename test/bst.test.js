...
describe('Binary search tree', function () {
  ...
  describe('Search', function () {
    ...
    it('Can search for data between two bounds', function () {
      ...
      assert.deepEqual(bst.betweenBounds({ $gte: 8, $lte: 15 }), [{ key: 8, data: 'data 8' }, { key: 10, data: 'data 10' }, { key: 13, data: 'data 13' }, { key: 15, data: 'data 15' }]);
      assert.deepEqual(bst.betweenBounds({ $gt: 8, $lt: 15 }), [{ key: 10, data: 'data 10'}, { key: 13, data: 'data 13'}]);
    });
    ...
    it('Bounded search can handle cases where query contains both $lt and $lte, or both $gt and $gte', function () {
      ...
      assert.deepEqual(bst.betweenBounds({ $gt:8, $gte: 8, $lte: 15 }), [{ key: 10, data: 'data 10' }, { key: 13, data: 'data 13' }, { key: 15, data: 'data 15' }]);
      assert.deepEqual(bst.betweenBounds({ $gt:5, $gte: 8, $lte: 15 }), [{ key: 8, data: 'data 8' }, { key: 10, data: 'data 10' }, { key: 13, data: 'data 13' }, { key: 15, data: 'data 15' }]);
      assert.deepEqual(bst.betweenBounds({ $gt:8, $gte: 5, $lte: 15 }), [{ key: 10, data: 'data 10' }, { key: 13, data: 'data 13' }, { key: 15, data: 'data 15' }]);

      assert.deepEqual(bst.betweenBounds({ $gte: 8, $lte: 15, $lt: 15 }), [{ key: 8, data: 'data 8' }, { key: 10, data: 'data 10' }, { key: 13, data: 'data 13' }]);
      assert.deepEqual(bst.betweenBounds({ $gte: 8, $lte: 18, $lt: 15 }), [{ key: 8, data: 'data 8' }, { key: 10, data: 'data 10' }, { key: 13, data: 'data 13' }]);
      assert.deepEqual(bst.betweenBounds({ $gte: 8, $lte: 15, $lt: 18 }), [{ key: 8, data: 'data 8' }, { key: 10, data: 'data 10' }, { key: 13, data: 'data 13' }, { key: 15, data: 'data 15' }]);
    });
    ...
    it('Bounded search can work when one or both boundaries are missing', function () {
      ...
      assert.deepEqual(bst.betweenBounds({ $gte: 11 }), [{ key: 13, data: 'data 13' }, { key: 15, data: 'data 15' }, { key: 18, data: 'data 18' }]);
      assert.deepEqual(bst.betweenBounds({ $lte: 9 }), [{ key: 3, data: 'data 3' }, { key: 5, data: 'data 5' }, { key: 8, data: 'data 8' }]);
    });
